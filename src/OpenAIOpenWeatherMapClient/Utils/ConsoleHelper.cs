...
internal static class ConsoleHelper
{
    ...
    public static void ShowHeader()
    {
        ...
        Grid grid = new();
        grid.AddColumn();
        grid.AddRow(new FigletText("ChatTools").Centered().Color(Color.Red));
    ...
    /// <summary>
    /// D   isplays a prompt with the provided options and returns the selected option.
    /// </summary>
    ...
    /// <param name="showHeader">Indicates whether to show the header.</param>
    /// <returns>The user input.</returns>
    public static string GetString(string prompt, bool showHeader = false)
    {
        if (showHeader)
        {
            ShowHeader();
